...
public class Constants {
	...
	public final static String FORM_TYPE_FLOW = "Flow";
	public final static String FORM_TYPE_DECISION = "Decision";
	...
	public final static String DEPENDENCE_OBJECT_TYPE_LOGIC_MAP = "LogicMap";
