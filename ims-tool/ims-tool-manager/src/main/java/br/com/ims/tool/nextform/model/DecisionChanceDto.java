...
public class DecisionChanceDto implements Serializable {
	...
	private long decisionGroupChild;
	...
	public long getDecisionGroupChild() {
		return decisionGroupChild;
	}
	public void setDecisionGroupChild(long decisionGroupChild) {
	...
	public String toString() {
		return "DecisionChoiceDto [id=" + id + ", decisionGroupId="
				+ decisionGroupId + ", order=" + order + ", operation="
				+ operation + ", value1=" + value1 + ", value2=" + value2
				+ ", value3=" + value3 + ", value4=" + value4 + ", value5="
				+ value5 + ", value6=" + value6 + ", value7=" + value7
				+ ", value8=" + value8 + ", value9=" + value9 + ", value10="
				+ value10 + ", decisionGroupChild=" + decisionGroupChild
				+ ", nextForm=" + nextForm + "]";
	}
